        ...
        <br/><br/><br/><br/>
        	<div class="row">
              ...
              <div class="col-sm-12">
                ...
                <img src="{{ asset('/images/seamco/seamco_logo.png') }}" alt="...">
                <!-- <div class="wpm_angle"></div> -->
              </div>
          ...
          <div class="modal-dialog" style="width:1000px;">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" style="background-color:#2ACCC0;">Continue for Registration</button>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
